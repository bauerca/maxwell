#ifndef MX_YEE_FIT_D_FIELD
#define MX_YEE_FIT_D_FIELD
...
template<size_t DIM>
class MxYeeFitDField : public MxYeeElecFieldBase<DIM> {
  public:
    MxYeeFitDField(const MxGrid<DIM> * aGrid, MxPolType polarization = TE);
